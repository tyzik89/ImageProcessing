...
public class Algorithm {
    ...
    /**
     * Сборка итоговой матрицы изображения из отдельных сегментов
     * @param segments
     * @return
     */
    public void doSynthesis(ArrayList<Mat> segments, Mat originalMat) {
    ...
    /**
     * Разбиение матрицы на сегменты заданного размера
     * @param source
     * @param sizeSegment
     * @return
     */
